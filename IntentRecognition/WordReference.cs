...
namespace IntentRecognition
{
    class Reference
    {
        public static string musicFile = @"C:\Users\Amr\Music\";
        public static string playlist = @"C:\Users\Amr\Music\Playlists\Movies.wpl";
       // public static string [] cityList =
            //File.ReadAllLines(@"C:\Users\Amr\Desktop\IntentRecognition\IntentRecognition\Citylist.txt");
        public static string[] readList = 
            File.ReadAllLines(@"C:\Users\Amr\Desktop\IntentRecognition\IntentRecognition\ApplicationList.txt");
        public static string[] gameList = 
            File.ReadAllLines(@"C:\Users\Amr\Desktop\IntentRecognition\IntentRecognition\GameList.txt");
        public static string[] appProcesses =
            File.ReadAllLines(@"C:\Users\Amr\Desktop\IntentRecognition\IntentRecognition\AppProcessList.txt");
        public static string[] FamousPeople =
            File.ReadAllLines(@"C:\Users\Amr\Desktop\IntentRecognition\IntentRecognition\FamousPeople.txt");
